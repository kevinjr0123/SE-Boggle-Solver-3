...
// Return an array of words from the dictionary if
// the grid includes all letters for a particular word in the dictionary
...
const grid = [['Qu', 'A', 'X', 'St', 'L'],
  ...
  ['M', 'R', 'I', 'C', 'K'],
  ['A', 'N', 'D', 'M', 'O']];
const dictionary = ['arf', 'ciel', 'derrick', 'army', 'hawaii', 'hero',
  'academia', 'still'];
